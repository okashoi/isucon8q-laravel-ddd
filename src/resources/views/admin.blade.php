...
<div id="container" class="container">
    ...
    <div id="app-wrapper" data-administrator="@isset($administrator){{ json_encode($administrator) }}@endisset" data-events="{{ json_encode($events) }}">
        @verbatim
...
<script type="text/javascript" src="{{ url('') }}/js/bootstrap-waitingfor.min.js"></script>
<script type="text/javascript" src="{{ url('') }}/js/vue.min.js"></script>
<script type="text/javascript" src="{{ url('') }}/js/fetch.min.js"></script>
